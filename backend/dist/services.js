...
exports.updateSettings = exports.getSettings = exports.getAnalytics = exports.getDashboardStats = exports.getRecords = exports.createRecord = void 0;
...
const getAnalytics = async () => {
    ...
    const avg = (field) => records.reduce((acc, r) => acc + r[field], 0) / count;
    const averages = {
        energia: avg('energia'),
    ...
    const factors = ['energia', 'estresse', 'tedio', 'clareza_mental'];
    ...
    if (Math.abs(topFactor.correlationImpulso) > 0.3) {
        const nameMap = { energia: 'energia', estresse: 'estresse', tedio: 'tédio', clareza_mental: 'clareza mental' };
